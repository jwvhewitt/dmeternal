...
RAISE_SPIRIT = Spell( "Raise Spirit",
    ...
    rank=6, gems={EARTH:2,LUNAR:2}, com_tar=targetarea.SingleTarget(reach=2), mpfudge=8 )
...
ACID_RAIN = Spell( "Acid Rain",
    ...
    ,) ), rank=6, gems={EARTH:1,WATER:3}, com_tar=targetarea.Blast(radius=5), ai_tar=invocations.vs_enemy )
...
FREEZE_RAY = Spell( "Freeze Ray",
    ...
    ,) ), rank=6, gems={LUNAR:2,WATER:1}, com_tar=targetarea.Blast(radius=2),ai_tar=invocations.vs_enemy,shot_anim=animobs.BlueComet )
...
SUMMONING = Spell( "Summoning",
    ...
    rank=7, gems={EARTH:2,LUNAR:3}, com_tar=targetarea.SingleTarget(reach=3), mpfudge=13 )
...
DEEP_DROWNING = Spell( "Deep Drowning",
    ...
    ,) ), rank=7, gems={LUNAR:2,WATER:2}, com_tar=targetarea.Blast(radius=1),ai_tar=invocations.vs_enemy,shot_anim=animobs.CrystalBall )
...
GREATER_SUMMONING = Spell( "Greater Summoning",
    ...
    rank=9, gems={EARTH:3,LUNAR:3}, com_tar=targetarea.SingleTarget(reach=3), mpfudge=17 )
