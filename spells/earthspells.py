...
EARTHBIND = Spell( "EARTHBIND", "Earthbind",
    ...
    rank=1, gems={EARTH:1}, com_tar=targetarea.Blast(radius=3), mpfudge=1 )

CALL_CRITTER = Spell( "CALL_CRITTER", "Call Critter",
    "This spell will summon a small woodland creature to fight on your behaf.",
    effects.CallMonster( {context.MTY_BEAST: True, context.DES_EARTH: context.MAYBE, context.GEN_NATURE: context.MAYBE}, 2, anim=animobs.OrangeSparkle ),
