...
#
#  HELLO.* -> SHOP( GENERALSTORE, BLACKMARKET, WEAPON, MAGICGOODS )
...
#  INFO -> INFO
#  PROBLEM -> PROBLEM
#  THREATEN -> REPLY_ATTACK
#  THREATEN -> REPLY_PEACE
...
HELLO,THREATEN,SHOP,SERVICE,INFO,PROBLEM,BRINGMESSAGE, REWARD, \
    ...
    REPLY_PEACE,GOODLUCK,LOCAL,TRAINING = range(24)
...
MTY_BEAST, MTY_HUMANOID, MTY_FIGHTER, MTY_THIEF, MTY_PRIEST, MTY_MAGE, \
    MTY_UNDEAD, MTY_CREATURE, MTY_LEADER, MTY_CONSTRUCT, MTY_DEMON, MTY_CELESTIAL = range(1300,1312)
