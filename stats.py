...
RESIST_LUNAR = SingStat( "RESIST_LUNAR", "Dark Resist", cost_mod = 20, element_name="Dark", element_cost_mod=3 )
RESIST_SOLAR = SingStat( "RESIST_SOLAR", "Holy Resist", cost_mod = 20, element_name="Holy", element_cost_mod=3 )

RESIST_WIND = SingStat( "RESIST_WIND", "Wind Resist", cost_mod = 15, element_name="Wind", element_cost_mod=2 )
RESIST_WATER = SingStat( "RESIST_WATER", "Water Resist", cost_mod = 15, element_name="Water", element_cost_mod=2 )
RESIST_ATOMIC = SingStat( "RESIST_ATOMIC", "Atomic Resist", cost_mod = 30, element_name="Atomic", element_cost_mod=5 )
RESIST_POISON = SingStat( "RESIST_POISON", "Poison Resist", cost_mod = 15, element_name="Poison", element_cost_mod=2 )
