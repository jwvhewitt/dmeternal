...
FLESHY = SingTemp( "FLESHY", { RESIST_CRUSHING: 50, RESIST_PIERCING: 50 } )
MUMMY = SingTemp( "MUMMY", { RESIST_CRUSHING: 50, RESIST_PIERCING: 75,
    RESIST_FIRE: -100, RESIST_WATER: -100, RESIST_SOLAR: 100 } )
...
ROCK = SingTemp( "ROCK", { RESIST_CRUSHING: 50, RESIST_PIERCING: 50,
    RESIST_SLASHING: 50, RESIST_WATER: -100, RESIST_COLD: -100 })
